 ...
 * <li> SINK:           Sink components provide display functionality and have no output port (optional PlatformView)
 * <li> RELAY_SINK:     Sink components which provide additionally an output value and an output port
 * <li> TOOL:           Complex computation components with no output port, use RELAY_SINK if tool provides an output value (optional StartableViewConsumer)
